    ...
    <div>
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input
                        type="text"
                        class="form-control"
                        :class="form.errors?.degree ? 'is-invalid' : ''"
                        placeholder="Input degree"
                        v-model="form.degree"
                    />
                    <div class="invalid-feedback" v-if="form.errors?.degree">{{ form.errors?.degree[0] }}</div>
                </div>
                <div class="mb-3">
            ...
            <div class="card-footer d-flex justify-content-end">
                <nuxt-link to="/degrees" class="btn btn-danger mx-1"><i class='bx bx-x'></i>Batal</nuxt-link>
...
<script>
    export default {
      ...
      async mounted(){
        const {data} = await this.$getOneDegrees(this.id)
      ...
      methods: {
            async submit(){
                ...
                await this.$updateDegrees(this.form, this.id).then(response=>{
