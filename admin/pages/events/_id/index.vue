        ...
        <div class="card p-3">
            ...
            <div class="card-body detail-data">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(sch, idx) in schedules" :key="`schedule_${idx}`">
                            <td>{{ sch.date }}</td>
                            <td>{{ sch.end_date }} </td>
                ...
                <div class="mt-4">
                    <div v-for="(syll, idx) in syllabus" :key="`syllabus_${idx}`">
                        <h4>{{ syll.title }} <small>{{ syll.sub_title }}</small></h4>
                        <ul class="list-group py-3 px-2">
                        <li class="list-group-item" v-for="(sub, idx2) in syll.details" :key="`detail_${idx2}`">
