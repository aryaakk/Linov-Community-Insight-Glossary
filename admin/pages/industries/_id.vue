    ...
    <div>
        <div class="card mb-4">
            ...
            <div class="card-footer d-flex justify-content-end">
                <nuxt-link to="/industries" class="btn btn-danger mx-1"><i class='bx bx-x'></i>Batal</nuxt-link>
...
<script>
    export default {
      ...
      async mounted(){
        const {data} = await this.$getOneIndustries(this.id)
      ...
      methods: {
            async submit(){
                ...
                await this.$updateIndustries(this.form, this.id).then(response=>{
