    ...
    <div>
        <div class="card mb-4">
            ...
            <div class="card-footer d-flex justify-content-end">
                <nuxt-link to="/university" class="btn btn-danger mx-1"><i class='bx bx-x'></i>Batal</nuxt-link>
...
<script>
    export default {
      ...
      async mounted(){
        const {data} = await this.$getOneUniversity(this.id)
      ...
      methods: {
            async submit(){
                ...
                await this.$updateUniversity(this.form, this.id).then(response=>{
