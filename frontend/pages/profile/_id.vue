<template>
    <div class="container">
        <div class="row pt-50 mt-4" ref="threads">
            <div class="col-lg-4 col-md-12">
                ...
                <div class="card row p-5 mt-4">
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <NuxtLink class="btn btn-primary btn-block" :to="`/consultation/create?consultant=${profile.id}`" style="color: white ;" v-if="(is_consultant && !is_current)"><i class="fas fa-pencil-alt"></i> Consultation Now</NuxtLink>
                    </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card mt-4">
                    ...
                    <div class="py-2">
                        ...
                        <div class="p-4" v-if="profile?.skills && profile?.skills.length>0">
                            <span class="px-1" v-for="(skill, idx) in profile?.skills||[]">
...
export default {
  ...
  async mounted(){
    ...
    this.getThreads();
    await this.$getUserProfile({}, this.params.id)
            .then(response=>{
